...
class ClientController extends Controller
{
    ...
    {
        $data = Client::find($id);
        return view('admin.owners.edit')->with('data', $data);
    }
    public function detail($id)
    {
        ...
        return view('admin.client.detail')->with('data', $data)->with('avatar', $avatar)->with('client', $client)->with('driving_licence_image', $driving_licence_image)->with('image_national_id', $image_national_id);
    }
    ...
    public function checkCamperDetail($id)
    {
        ...
        $client = Client::find($id);
        return view('admin.client.detailCamper')->with('datas', $datas)->with('client', $client);
    }
    public function checkBookingDetail($id)
    {
        ...
        return view('admin.client.bookingDetail')->with('datas', $datas)->with('remaining_days', $remaining_days)->with('client', $client);
    }
    ...
    public function clientCampers($id)
    {
        ...
        return view('admin.client.clientCampers')
            ->with('datas', $datas)
            ->with('client', $client)
    ...
    public function clientBookings($id)
    {
        ...
        $client = Client::find($id);
        return view('admin.client.clientBookings')->with('datas', $datas)->with('client', $client);
    }
