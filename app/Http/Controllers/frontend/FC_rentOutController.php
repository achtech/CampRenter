...
class FC_rentOutController extends Controller
{
    ...
    public function storeterms(Request $request)
    {
        ...
        $season_off1 = DB::table('camper_terms')->where('id_campers', $camper->id)->where('season', 'Off_may')->first();
        $season_off2 = DB::table('camper_terms')->where('id_campers', $camper->id)->where('season', 'Off_sept')->first();
        ...
        return view('frontend.camper.rent_out.conditions')
            ...
            ->with('season_off1', $season_off1)
            ->with('season_off2', $season_off2);
    }
    ...
    public function savecalendar(Request $request)
    {
        ...
        if ($request->price_per_night_main != null && $request->price_per_night_main != null) {
            $camper_terms_main = $camper_terms;
            $camper_terms_main->season == 'Main_season (Jul - Aug)';
        ...
        } elseif ($request->price_per_night_off != null && $request->minimum_night_off != null) {
            $camper_terms_off = $camper_terms;
            $camper_terms_off->season == 'Off season (May - Jun)';
            ...
            $camper_terms_off->start_month = 7;
            $camper_terms_off->end_month = 8;
            $camper_terms_off->id_campers = $camper->id;
            $camper_terms_off->save();

        } elseif ($request->price_per_night_winter != null && $request->minimum_night_winter != null) {
            $camper_terms_winter = $camper_terms;
            $camper_terms_winter->season == 'winter season (May - Jun)';
            ...
            $camper_terms_winter->start_month = 7;
            $camper_terms_winter->end_month = 8;
