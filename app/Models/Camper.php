...
class Camper extends Base
{
    ...
    protected $fillable = ['is_completed','image', 'camper_name', 'camper_status', 'brand', 'model', 'value_of_vehicule', 
    'license_plate_number', 'seat_number', 'sleeping_places', 'vehicle_licence', 'length', 'width', 'height', 'description_camper', 
    'location', 'price_per_day', 'minimal_rent_days', 'included_kilometres', 'minimum_age', 'animals_allowed', 'animal_description', 
    'licence_needed_desc', 'license_age', 'licence_age_desc', 'smoking_allowed', 'availability', 'is_confirmed', 
