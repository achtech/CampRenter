...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 23 sep. 2020 à 17:59
...
INSERT INTO `users` (`id`, `user_name`, `email`, `password`, `id_avatars`, `telephone`, `adress`, `created_at`, `created_by`, `updated_at`, `updated_by`) VALUES
(1, 'test', 'test', 'test', 0, '', '', NULL, NULL, NULL, NULL);
