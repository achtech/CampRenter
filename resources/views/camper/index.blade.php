                                                    ...
                                                    <!-- Modal content-->
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="{{ route('camper.index').'/'.$item->id.'/block' }}" class="btn btn-danger btn-sm rounded-0"> {{ __('backend.client_block.btn') }}</a>
                                                ...
                                                <div class="modal fade" id="activate" role="dialog">
                                                    ...
                                                    <!-- Modal content-->
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                <a href="{{ route('camper.index').'/'.$item->id.'/active' }}" class="btn btn-danger btn-sm rounded-0"> {{ __('backend.client_activate.btn') }}</a>
                                                                <!--<button type="button" class="btn btn-default" data-dismiss="modal" class="btn btn-primary btn-sm rounded-0">Close</button>-->
                                                            </div>
                                                        </div>
                                                    </div>
