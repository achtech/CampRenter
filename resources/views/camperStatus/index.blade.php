...
@section('content')
{{ Breadcrumbs::render('camperStatus') }}
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="{{ route('camperStatus.create') }}" class="btn waves-effect waves-light btn-rounded btn-rounded btn-primary float-right add-class" 
                            style="width:200px;margin:0px 10px">{{ __('backend.new_camperStatus.btn') }}</a>
                                   ...
                                   <td>
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <a href="{{ route('camperStatus.edit',$item->id)}}" class="btn btn-success btn-sm rounded-0"><i class="far fa-edit"></i></a>
                                            </li>  
                                            <li class="list-inline-item">
                                                <div class="container">
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <p>{{ __('backend.message_delete_camperStatus.lbl') }}</p>
                </div>
                <div class="modal-footer">
                    <a href="{{ route('camperStatus.index').'/'.$item->id.'/delete' }}" class="btn btn-danger btn-sm rounded-0">Delete</a>
