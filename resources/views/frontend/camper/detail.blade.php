		...
		<div class="col-lg-8 col-md-8 padding-right-30">
			...
			<div id="listing-gallery" class="listing-section">
				...
				<div class="listing-slider-small mfp-gallery-container margin-bottom-0">
					<a href="{{asset('frontend/asset/images/single-listing-02a.jpg')}}" data-background-image="{{asset('frontend/asset/images/single-listing-02a.jpg')}}" class="item mfp-gallery" title="Title 2"></a>
					<a href="{{asset('frontend/asset/images/single-listing-01a.jpg')}}" data-background-image="{{asset('frontend/asset/images/single-listing-01a.jpg')}}" class="item mfp-gallery" title="Title 1"></a>
					<a href="{{asset('frontend/asset/images/single-listing-03a.jpg')}}" data-background-image="{{asset('frontend/asset/images/single-listing-03a.jpg')}}" class="item mfp-gallery" title="Title 3"></a>
					<a href="{{asset('frontend/asset/images/single-listing-04a.jpg')}}" data-background-image="{{asset('frontend/asset/images/single-listing-04a.jpg')}}" class="item mfp-gallery" title="Title 3"></a>
				</div>
			</div>
