                    ...
                    <div class="row" >
                        <div class="col-24" >
                            ...
                            <div class="mcplaceholder mb-3" >
                                <input id="plainPassword" style="width:90%;" type="password" id="password" name="password" placeholder="{{trans('front.password')}}" required="required" aria-required="true" value="" class="form-control" >
                                <input id="plainPassword" style="width:90%;" type="password" id="confirmed" name="confirmed" placeholder="{{trans('front.confirm_password')}}" required="required" aria-required="true" value="" class="form-control" >
                            </div>
                        </div>
                        @error('password')
