                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="{{ route('camperCategory.create') }}" class="btn waves-effect waves-light btn-rounded btn-rounded btn-primary float-right add-class" 
                            style="width:200px;margin:0px 10px">{{ __('backend.new_camperCategory.btn') }}</a>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <p>{{ __('backend.message_delete_camperCategory.lbl') }}</p>
                </div>
                <div class="modal-footer">
                    <a href="{{ route('camperCategory.index').'/'.$item->id.'/delete' }}" class="btn btn-danger btn-sm rounded-0">Delete</a>
