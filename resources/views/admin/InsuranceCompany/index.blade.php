@extends('admin.layout', ['activePage' => 'insurance_company', 'titlePage' => trans('backend.insurance_company_managment')])
@section('content')
                    ...
                    <div class="table-responsive">
                        ...
                        <table id="default_order" class="table table-striped table-bordered display no-wrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td>
                                    <img style="width:64px;height:64px;" src="{{ asset('assets/admin/images') }}/insuranceCompany/{{$item->logo}}" >
                                </td>
                                <td>{{$item->name}}</td>
                                    <td></td>
                                   <td>
...
<div class="modal modal-danger fade" id="deletePrgModal" tabindex="-1"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  action="{{route('insuranceCompany.delete','test')}}" method="post">
            {{method_field('delete')}}
            {{csrf_field()}}
          <div class="modal-body">
                    {{__('backend.message_delete_insurance_company')}}
