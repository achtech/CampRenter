@extends('admin.layout', ['activePage' => 'fuel', 'titlePage' => trans('backend.fuel_managment')])
@section('content')
{{ Breadcrumbs::render('create_fuel') }}
<div class="container-fluid">
    <!--'action'=>'FuelController@store',-->
    {{ Form::open(['action'=>'App\Http\Controllers\admin\FuelController@store','autocomplete'=>'off','method'=>'POST']) }}
    <div class="row">
