@extends('admin.layout', ['activePage' => 'transmission', 'titlePage' => trans('backend.transmission_managment')])
@section('content')
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="{{ route('transmission.create') }}" class="btn waves-effect waves-light btn-rounded btn-rounded btn-primary float-right add-class"
                            style="width:200px;margin:0px 10px">{{ __('backend.new_transmission') }}</a>
                                   ...
                                   <td>
                                        <ul class="list-inline m-0">
                                            <li class="list-inline-item">
                                                <a href="{{ route('transmission.edit',$item->id)}}" class="btn btn-success btn-sm rounded-0"><i class="far fa-edit"></i></a>
                                            </li>
                                            <li class="list-inline-item">
                                                <div class="container">
                                                <div class="container">
...
<div class="modal modal-danger fade" id="deletePrgModal" tabindex="-1"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  action="{{route('transmission.delete','test')}}" method="post">
            {{method_field('delete')}}
            {{csrf_field()}}
          <div class="modal-body">
                    {{__('backend.message_delete_transmission')}}
