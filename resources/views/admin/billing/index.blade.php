@extends('admin.layout', ['activePage' => 'billing', 'titlePage' => trans('backend.billing_managment')])
@section('content')
{{ Breadcrumbs::render('billing') }}
<div class="container-fluid">
    {{ Form::open(['action'=>'App\Http\Controllers\admin\BillingController@filter','autocomplete'=>'off','method'=>'GET']) }}
        <div class="row">
