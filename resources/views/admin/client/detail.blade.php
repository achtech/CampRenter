                                ...
                                <div class="card-body">
                                    <div class="mt-4">
                                        <div class="form-group">
                                            <img style="height: 100px;" src="{{ asset('assets/admin/images/avatar') }}/{{$avatar}}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <div class="form-group">
                                            <a data-fancybox="gallery" class="primary-btn"
                                                href="{{ asset('assets/admin/images/clients') }}/{{$data->driving_licence_image}}"><img
                                                    style="height: 100px;"
                                                    src="{{ asset('assets/admin/images/clients') }}/{{$data->driving_licence_image}}" /></a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mt-4">
                                        <div class="form-group">
                                            <a data-fancybox="gallery" class="primary-btn"
                                                href="{{ asset('assets/admin/images/clients') }}/{{$data->image_national_id}}"><img
                                                    style="height: 100px;"
                                                    src="{{ asset('assets/admin/images/clients') }}/{{$data->image_national_id}}" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
