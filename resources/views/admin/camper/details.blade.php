                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="mt-4">
                                <div class="form-group">
                                    @if($data->availability==0)
                                        Blocked by Owner {{App\Http\Controllers\admin\CamperController::getName('clients',$data->id_clients)}}
                                    @elseif($data->availability==1)
                                        Reserved by {{App\Http\Controllers\admin\CamperController::getName('clients',$data->id_clients)}}
                                        <br />From : {{App\Http\Controllers\admin\CamperController::getBookingCamperStart($data->id)}}
                                        <br />To  &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp{{App\Http\Controllers\admin\CamperController::getBookingCamperEnd($data->id)}}
                                    @else
                                        Available
                                    @endif
                                </div>
                                ...
                                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        ...
                                        <div class="carousel-item @if ($loop->first) active @endif" >
                                            <img class="img-fluid" src="{{ asset('assets/admin/images/campers')}}/{{$item->image}}" alt="First slide">
                                        </div>
                                        @endforeach
