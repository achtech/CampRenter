                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="form-group">
                                {{Form::text('title_de',$data->title_de,['class'=>'form-control','required'])}}
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="form-group">
                                {{Form::textarea('article_de',$data->article_de,['class'=>'form-control','required'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="form-group">
                                {{Form::textarea('article_en',$data->article_en,['class'=>'form-control','required'])}}
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-12 col-md-6 col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="form-group">
                                {{Form::text('title_fr',$data->title_fr,['class'=>'form-control','required'])}}
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <div class="form-group">
                                {{Form::textarea('article_fr',$data->article_fr,['class'=>'form-control','required'])}}
                            </div>
                        </div>
                    </div>
                </div>
