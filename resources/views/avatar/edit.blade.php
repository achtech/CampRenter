...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="col-sm-12">
                ...
                <a href="{{ route('avatar.index') }}" class="btn waves-effect waves-light btn-rounded btn-rounded btn-primary float-right" style="width:200px">{{ __('backend.cancel.btn') }}</a>
            </div>
    </div>
    {{ Form::close() }}
</div>
