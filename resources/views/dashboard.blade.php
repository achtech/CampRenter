                ...
                <div class="row">
                    <div class="col-md-4">
                        <div style="margin:10px">
                                ...
                                style="position: absolute;bottom:10px;width: 90%;">{{ __('backend.dashboard_new_promotion.btn') }}</a>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div style="margin:10px">
                    ...
                    <div class="col-md-6">
                        <div class="card" style="min-height: 423px;" >
                            ...
                            <tbody>
                                @if(count($bookings)==0)
                                    <tr>
                                        <td colspan="3" style="text-align: center;">{{ __('backend.no_data_found.lbl') }}</td>
                                    </tr>
                                @endif
