...
@section('content')
{{ Breadcrumbs::render('edit_camperNames',$data) }}
<div class="container-fluid">
    <!--'action'=>'App\Http\Controllers\CamperNamesController@update',-->
    {{ Form::open(array('method'=>'PUT','route' => ['camperNames.update', $data->id])) }}
