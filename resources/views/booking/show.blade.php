                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="form-group row">
                                    <div  class="col-md-6"><label>{{ __('backend.booking_price_per_day.lbl') }}</label></div>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-6">{{ __('backend.booking_total_price.lbl') }} </label>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                ...
                                <div class="form-group row">
                                    <label class="col-md-6">{{ __('backend.status_billing.lbl') }} </label>
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
