...
return [
    ...
    'backup' => [
         ...
         * the backups.
         */
        'name' => env('APP_NAME', 'campunit-backup'),
        'source' => [
...
/*            'to' => 'your@example.com',
        ...
        */      ],
        ...
        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
    ...
    'monitor_backups' => [
        [
            'name' => env('APP_NAME', 'Campunit-database-backup'),
            'disks' => ['local'],
            'health_checks' => [
